...
ActiveRecord::Schema.define(:version => 20100727065504) do

  create_table "area_profile_versions", :force => true do |t|
    t.integer  "area_profile_id"
    t.integer  "version"
    t.string   "name"
    t.string   "address1"
    t.string   "address2"
  ...
  create_table "area_profiles", :force => true do |t|
    t.integer  "version"
  ...
  create_table "news_event_versions", :force => true do |t|
  ...
  create_table "promotion_versions", :force => true do |t|
  ...
  create_table "property_display_image_versions", :force => true do |t|
    t.integer  "property_display_image_id"
    t.integer  "version"
    t.integer  "attachment_id"
    t.integer  "attachment_version"
    t.integer  "property_id"
  ...
  create_table "property_display_images", :force => true do |t|
    t.integer  "version"
    t.integer  "lock_version",       :default => 0
    t.integer  "attachment_id"
    t.integer  "attachment_version"
  ...
  create_table "property_logo_versions", :force => true do |t|
    t.integer  "property_logo_id"
    t.integer  "version"
    t.integer  "attachment_id"
    t.integer  "attachment_version"
    t.integer  "property_id"
  ...
  create_table "property_logos", :force => true do |t|
    t.integer  "version"
    t.integer  "lock_version",       :default => 0
    t.integer  "attachment_id"
    t.integer  "attachment_version"
  ...
  create_table "property_versions", :force => true do |t|
    t.integer  "property_id"
    t.integer  "version"
    t.string   "name"
    t.text     "description"
  ...
  create_table "subscription_versions", :force => true do |t|
